...
legend('mass with ICL controller', 'mass with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
...
legend('CoM with ICL controller', 'CoM with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
...
grid on
legend('$I_{xx}$ with ICL controller', '$I_{xx}$ with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
xlim([0, t(end)])
...
grid on
legend('$I_{yy}$ with ICL controller', '$I_{yy}$ with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
xlim([0, t(end)])
...
grid on
legend('$I_{zz}$ with ICL controller', '$I_{zz}$ with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
xlim([0, t(end)])
...
grid on
legend('$I_{xy}$ with ICL controller', '$I_{xy}$ with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
xlim([0, t(end)])
...
grid on
legend('$I_{xz}$ with ICL controller', '$I_{xz}$ with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
xlim([0, t(end)])
...
grid on
legend('$I_{yz}$ with ICL controller', '$I_{yz}$ with adaptive controller', 'ground truth', 'Interpreter', 'latex', 'Location','southeast')
xlim([0, t(end)])
...
set(y_label, 'Units', 'Normalized', 'Position', [-0.13, 0.47]);
xlabel('Time (s)', 'Fontsize', 11)
legend('$e_{r1}$ with ICL controller', '$e_{r2}$ with ICL controller', '$e_{r1}$ with adaptive controller', '$e_{r2}$ with adaptive controller', 'Interpreter', 'latex', 'Location','northeast')
title('Attachment-point Errors', 'Fontsize', 11)
