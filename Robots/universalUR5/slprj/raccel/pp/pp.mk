...
MODEL                = pp
MODULES              = coder_posix_time.c pp_43e6ab1_1.c pp_43e6ab1_1_create.c pp_43e6ab1_1_setParameters.c pp_43e6ab1_1_asserts.c pp_43e6ab1_1_deriv.c pp_43e6ab1_1_checkDynamics.c pp_43e6ab1_1_compOutputs.c pp_43e6ab1_1_asm_delegate.c pp_43e6ab1_1_sim_delegate.c pp_43e6ab1_1_mode_zero_crossings.c pp_43e6ab1_1_geometries.c pp_43e6ab1_1_gateway.c pm_printf.c rt_logging_simtarget.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c pp.c pp_capi.c pp_data.c pp_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = pp.exe
MAKEFILE             = pp.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2021a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2021a
START_DIR            = D:/ABB 6-DOF Robots Simscape/Robots/universalUR5
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pp_ref.rsp
...
coder_posix_time.obj : $(MATLAB_ROOT)/toolbox/eml/externalDependency/timefun/coder_posix_time.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/eml/externalDependency/timefun/coder_posix_time.c
